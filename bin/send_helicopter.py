...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        w = Scale(from_=0.01, to=100.0, orient=HORIZONTAL, command=self.set_r_s, resolution=0.01)
...
###########
        ...
        w = Scale(from_=0, to=0.5, orient=HORIZONTAL, command=self.set_N_prim, resolution=0.1)
